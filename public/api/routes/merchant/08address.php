...
Route::prefix('address')->group(function () {
    ...
    //获取详情
    /**
     * @api {get} /merchant/address/{id} 地址详情
     * @apiName 地址详情
     * @apiGroup 08address
     * @apiVersion 1.0.0
     * @apiUse auth
    ...
    //新增
    /**
     * @api {post} /merchant/address/{id} 地址新增
     * @apiName 地址新增
     * @apiGroup 08address
     * @apiVersion 1.0.0
     * @apiUse auth
    ...
    //修改
    /**
     * @api {put} /merchant/address/{id} 地址修改
     * @apiName 地址修改
     * @apiGroup 08address
     * @apiVersion 1.0.0
     * @apiUse auth
    ...
    //删除
    /**
     * @api {delete} /merchant/address/{id} 地址删除
     * @apiName 地址删除
     * @apiGroup 08address
     * @apiVersion 1.0.0
     * @apiUse auth
