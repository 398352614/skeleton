 ...
 * {"order_no_list":"TMS00001,TMS00002,TMS00003","no_push":1}
 * @apiSuccess {Number} code    状态码，200：请求成功
 * @apiSuccess {String} msg   提示信息
 * @apiSuccess {Object} data    返回数据
 * @apiSuccessExample {json} Success-Response:
...
/**
 * @api {post} /merchant_api/post-code-date-list 获取可预约日期
 * @apiName 通过地址获取可预约日期
 * @apiGroup 01order
 * @apiVersion 1.0.0
 * @apiUse auth
 ...
 * @apiSuccess {String} msg   提示信息
 * @apiSuccess {Object} data    返回数据
 * @apiSuccess {String} data.expect_distance    预计里程（公里）
 * @apiSuccess {String} data.actual_distance    实际里程（公里）
 ...
 * @apiSuccess {String} data.out_order_no    外部订单号
 * @apiSuccess {String} data.rest_batch    剩余站点数，指运到该客户之前，还有多少个客户没运。
 * @apiSuccessExample {json} Success-Response:
...
/**
 * @api {post} /merchant_api/order-update 订单修改
 * @apiName 订单修改
 * @apiGroup 01order
 * @apiVersion 1.0.0
 * @apiUse auth
