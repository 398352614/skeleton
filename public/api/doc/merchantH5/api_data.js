define({ "api": [
  {
    ...
    "filename": "public/api/routes/merchantH5/01auth.php",
    "groupTitle": "用户认证",
    "sampleRequest": [
      {
  ...
  {
    "type": "post",
    "url": "/merchant_h5/register/apply",
    "title": "注册验证码",
    "name": "注册-验证码",
    "group": "01auth",
    "version": "1.0.0",
  ...
  {
    "type": "put",
    "url": "/merchant_h5/password/reset",
    "title": "重置密码",
    "name": "重置密码",
    "group": "01auth",
    "version": "1.0.0",
  ...
  },
  {
    ...
    "filename": "public/api/routes/merchantH5/02comon.php",
    "groupTitle": "公共接口",
    "sampleRequest": [
      {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "string",
            "optional": false,
            "field": "data.admin_url",
            "description": "<p>管理员端域名,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.admin_login_background",
            "description": "<p>管理员端登录背景,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.admin_login_title",
            "description": "<p>管理员端登录标题,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.admin_main_logo",
            "description": "<p>管理员端主界面logo,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.merchant_url",
            "description": "<p>货主端域名,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.merchant_login_background",
            "description": "<p>货主端登录背景,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.merchant_login_title",
            "description": "<p>货主端登录标题,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.merchant_main_logo",
            "description": "<p>货主端主界面logo,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.driver_login_title",
            "description": "<p>司机端主界面logo,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.consumer_url",
            "description": "<p>客户端域名,</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "data.consumer_login_title",
            "description": "<p>货主端主界面logo,</p>"
          }
        ]
      },
  ...
  },
  {
    ...
    "filename": "public/api/routes/merchantH5/04config.php",
    "groupTitle": "配置",
    "sampleRequest": [
      {
  ...
  {
    "type": "delete",
    "url": "/merchant_h5/order/{id}/remove-batch",
    "title": "取消预约",
    "name": "取消预约",
    "group": "05order",
    "version": "1.0.0",
    ...
    "filename": "public/api/routes/merchantH5/05order.php",
    "groupTitle": "订单管理",
    "sampleRequest": [
      {
  ...
  {
    "type": "get",
    "url": "/merchant_h5/order/{id}/trail",
    "title": "订单轨迹",
    "name": "订单轨迹",
    "group": "05order",
    "version": "1.0.0",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response:",
          "content": "{\"code\":200,\"data\":{\"id\":4222,\"company_id\":3,\"merchant_id\":121,\"merchant_id_name\":\"\\u540c\\u57ce\\u6d3e\\u9001\",\"order_no\":\"SMAAAFA0001\",\"execution_date\":\"2021-06-12\",\"second_execution_date\":\"2021-06-12\",\"out_order_no\":\"BG608NL2075\",\"mask_code\":\"2056\",\"source\":\"3\",\"source_name\":\"\\u7b2c\\u4e09\\u65b9\",\"list_mode\":1,\"transport_mode\":1,\"transport_mode_name\":\"\\u6574\\u8f66\",\"origin_type\":1,\"control_mode\":1,\"control_mode_name\":null,\"origin_type_name\":\"\\u4ece\\u7f51\\u70b9\\u51fa\\u53d1\\uff0c\\u56de\\u5230\\u7f51\\u70b9\",\"type\":3,\"type_name\":\"\\u63d0\\u8d27->\\u7f51\\u70b9->\\u914d\\u9001\",\"out_user_id\":\"904566\",\"nature\":1,\"settlement_type\":1,\"settlement_type_name\":\"\\u73b0\\u4ed8\",\"settlement_amount\":\"25.00\",\"replace_amount\":\"0.00\",\"delivery\":2,\"delivery_name\":\"\\u5426\",\"status\":3,\"sticker_amount\":\"0.00\",\"delivery_amount\":\"0.00\",\"status_name\":\"\\u5df2\\u5b8c\\u6210\",\"second_place_fullname\":\"Ann\",\"second_place_phone\":\"0031123456789\",\"second_place_country\":\"NL\",\"second_place_country_name\":\"\\u8377\\u5170\",\"second_place_province\":\"Noord-Holland\",\"second_place_post_code\":\"1118CP\",\"second_place_house_number\":\"202\",\"second_place_city\":\"Schiphol\",\"second_place_district\":\"Haarlemmermeer\",\"second_place_street\":\"Evert van de Beekstraat\",\"second_place_address\":\"NL Schiphol Evert van de Beekstraat 202 1118CP\",\"second_place_lon\":\"4.74791023\",\"second_place_lat\":\"52.30389933\",\"place_fullname\":\"Nie\",\"place_phone\":\"0031123654789\",\"place_country\":\"NL\",\"place_country_name\":\"\\u8377\\u5170\",\"place_province\":\"\",\"place_post_code\":\"1055RZ\",\"place_house_number\":\"94\",\"place_city\":\"Amsterdam\",\"place_district\":\"\",\"place_street\":\"Nieuwpoortstraat\",\"place_address\":\"NL Amsterdam Nieuwpoortstraat 94 1055RZ\",\"place_lon\":\"4.85681831\",\"place_lat\":\"52.38420131\",\"special_remark\":null,\"remark\":null,\"starting_price\":\"5.00\",\"transport_price_type\":\"2\",\"transport_price_type_name\":\"\\u9636\\u68af\\u56fa\\u5b9a\\u503c\\u8ba1\\u7b97\\uff08\\u56fa\\u5b9a\\u8d39\\u7528+\\uff08\\u91cd\\u91cf\\u4ef7\\u683c\\u6863\\uff09*\\uff08\\u91cc\\u7a0b\\u4ef7\\u683c\\u6863\\uff09\\uff09\",\"receipt_type\":1,\"receipt_type_name\":\"\\u539f\\u5355\\u8fd4\\u56de\",\"receipt_count\":0,\"create_date\":null,\"created_at\":\"2021-06-11 05:57:47\",\"updated_at\":\"2021-06-11 06:08:59\",\"item_list\":null,\"expect_total_amount\":\"0.00\",\"actual_total_amount\":\"0.00\",\"pickup_warehouse_lon\":\"4.87510019\",\"pickup_warehouse_lat\":\"52.31153083\",\"pie_warehouse_lon\":null,\"pie_warehouse_lat\":null,\"trail_list\":[{\"id\":11319,\"company_id\":3,\"type\":11,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u6d3e\\u4ef6]\\u5b8c\\u6210\",\"created_at\":\"2021-06-11 06:09:00\"},{\"id\":11316,\"company_id\":3,\"type\":4,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u6d3e\\u4ef6]\\u5f00\\u59cb\",\"created_at\":\"2021-06-11 06:08:16\"},{\"id\":11313,\"company_id\":3,\"type\":2,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u6d3e\\u4ef6]\\u51c6\\u5907\\u4e2d\\uff0c\\u8d27\\u54c1\\u5df2\\u9501\\u5b9a\",\"created_at\":\"2021-06-11 06:07:37\"},{\"id\":11310,\"company_id\":3,\"type\":7,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u6d3e\\u4ef6]\\u8fd0\\u5355\\u521b\\u5efa\\uff0c\\u751f\\u6210\\u8fd0\\u5355\\u53f7[YD00030005599]\\uff0c\\u65e5\\u671f[2021-06-12]\",\"created_at\":\"2021-06-11 06:03:38\"},{\"id\":11308,\"company_id\":3,\"type\":5,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u53d6\\u4ef6]\\u5b8c\\u6210\",\"created_at\":\"2021-06-11 06:00:31\"},{\"id\":11305,\"company_id\":3,\"type\":4,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u53d6\\u4ef6]\\u5f00\\u59cb\",\"created_at\":\"2021-06-11 06:00:00\"},{\"id\":11302,\"company_id\":3,\"type\":2,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355[\\u53d6\\u4ef6]\\u51c6\\u5907\\u4e2d\\uff0c\\u8d27\\u54c1\\u5df2\\u9501\\u5b9a\",\"created_at\":\"2021-06-11 05:59:50\"},{\"id\":11299,\"company_id\":3,\"type\":1,\"order_no\":\"SMAAAFA0001\",\"content\":\"\\u8ba2\\u5355\\u521b\\u5efa\\u6210\\u529f\\uff0c\\u8ba2\\u5355\\u53f7[SMAAAFA0001]\\uff0c\\u751f\\u6210\\u8fd0\\u5355\\u53f7[YD00030005597]\",\"created_at\":\"2021-06-11 05:57:47\"}]},\"msg\":\"successful\"}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/merchant_h5/order/price-count",
    "title": "运价估算",
    "name": "运价估算",
    "group": "05order",
    "version": "1.0.0",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.count_settlement_amount",
            "description": "<p>预计运费</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/merchant_h5/order/get-date",
    "title": "通过地址获取可选日期",
    "name": "通过地址获取可选日期",
    "group": "05order",
    "version": "1.0.0",
  ...
  {
    "type": "get",
    "url": "/merchant_h5/order/{id}/get-date",
    "title": "通过订单获取可选日期",
    "name": "通过订单获取可选日期",
    "group": "05order",
    "version": "1.0.0",
  ...
  {
    "type": "put",
    "url": "/merchant_h5/order/{id}/assign-batch",
    "title": "重新预约",
    "name": "重新预约",
    "group": "05order",
    "version": "1.0.0",
  ...
  },
  {
    ...
    "filename": "public/api/routes/merchantH5/08address.php",
    "groupTitle": "地址管理",
    "sampleRequest": [
      {
  ...
  {
    "type": "get",
    "url": "/merchant_h5/transport-price",
    "title": "运价查询",
    "name": "运价查询",
    "group": "09price",
    "version": "1.0.0",
    ...
    "filename": "public/api/routes/merchantH5/09price.php",
    "groupTitle": "运价信息",
    "sampleRequest": [
      {
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>网点功能1-取-2派3-仓配一体</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "string",
            "optional": false,
            "field": "data.data.warehouse_name",
            "description": "<p>网点名</p>"
          }
        ]
      },
    ...
    "filename": "public/api/routes/merchantH5/10warehouse.php",
    "groupTitle": "网点",
    "sampleRequest": [
      {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "pay_type",
            "description": "<p>支付方式1-银行转账2-支票3-现金4-余额</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
