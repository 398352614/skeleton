define({ "api": [
  {
    ...
    "description": "<p>加密方式示例文件，暂时仅提供php版本，下载地址：<code>www.rrtms.com<code></p>",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "group": "01order",
    "version": "1.0.0",
    "description": "<p>线路分配规则为邮编的情况，邮编必填；线路分配规则为区域的情况，经纬度必填，线路分配规则请在管理员端-配置管理-调度管理-调度规则页面确认或修改。</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
