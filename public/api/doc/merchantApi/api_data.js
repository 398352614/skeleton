define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>地址栏不是真实的推送地址。推送地址由第三方提供，所有的推送都会推送到第三方提供的地址。目前仅提供简略模式，只推送状态不推送相关数据。对于请求返回，仅验证返回值中ret是否为1，1表示推送成功。如果返回值中没有ret或者不需要第三方推送记录，那么TMS将不会解析推送后的返回值。</p>",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "https://dev-tms.nle-tech.com/api/push"
      }
    ]
  }
] });
