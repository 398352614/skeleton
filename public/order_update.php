...
//订单新增的接口
$api = "tms-api.test/api/merchant_api/order-update-phone-date";
/**
 * 包裹列表
 * name 包裹名称,必填
...
/*$packageList = [
    [
        'name' => '包裹1',
        'express_first_no' => 'express_001qw',
        'express_second_no' => 'express_002qwq',
        'out_order_no' => '1212121wq',
        'weight' => '12.12',
        'expect_quantity' => '1',
        'remark' => ''
    ],
    [
        'name' => '包裹2',
        'express_first_no' => 'express_0021qqw',
        'express_second_no' => 'express_00212ss',
        'out_order_no' => '1212121wq12121',
        'weight' => '12.12',
        'expect_quantity' => '1',
        'remark' => ''
    ],
...
//参数
$options = [
    'execution_date' => '2020-08-10',               //取派日期,必填
    'order_no' => 'SMAAABSM0001',                                  //订单编号
    'receiver_phone' => '12145',                          //收货方电话,必填
