...
return [
    ...
    "orderOut" => [
        ...
        'out_user_id' => '外部客户ID',
        'out_order_no' => '外部订单号',
        'sender_post_code' => '派件邮编',
        'sender_house_number' => '派件门牌号',
        'sender_execution_date' => '派件日期',
        'receiver_post_code' => '收件邮编',
        'receiver_house_number' => '收件门牌号',
        'receiver_execution_date' => '收件日期',
        'package_name' => '包裹',
        'package_quantity' => '包裹数量',
        'material_name' => '材料',
