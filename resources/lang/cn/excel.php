...
return [
    ...
    "order"=>[
        ...
        "receiver"=>"*收件人姓名",
        "receiver_phone"=>"*收件人电话",
        "receiver_country_name"=>"*收件人国家",
        "receiver_post_code"=>"*收件人邮编",
        "receiver_house_number"=>"*收件人门牌号",
        "receiver_address"=>"*收件人详细地址",
        "execution_date"=>"*取派日期",
        "settlement_type_name"=>"*结算类型",
        "settlement_amount"=>"运费金额",
        "replace_amount"=>"代收货款",
        "out_order_no"=>"外部订单号",
        "delivery_name"=>"是否送货上门",
        "remark"=>"备注",

        "item_type_name_1"=>"*物品一类型",
        "item_name_1"=>"*物品一名称",
        "item_number_1"=>"物品一扫码编号",
        "item_count_1"=>"物品一数量",
        "item_weight_1"=>"物品一重量",

        "item_type_name_2"=>"物品二类型",
        "item_name_2"=>"物品二名称",
        "item_number_2"=>"物品二扫码编号",
        "item_count_2"=>"物品二数量",
        "item_weight_2"=>"物品二重量",

        "item_type_name_3"=>"物品三类型",
        "item_name_3"=>"物品三名称",
        "item_number_3"=>"物品三扫码编号",
        "item_count_3"=>"物品三数量",
        "item_weight_3"=>"物品三重量",

        "item_type_name_4"=>"物品四类型",
        "item_name_4"=>"物品四名称",
        "item_number_4"=>"物品四扫码编号",
        "item_count_4"=>"物品四数量",
        "item_weight_4"=>"物品四重量",

        "item_type_name_5"=>"物品五类型",
        "item_name_5"=>"物品五名称",
