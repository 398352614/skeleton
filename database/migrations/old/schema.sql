...
CREATE TABLE `material`  (
  ...
  `out_order_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '外部订单号/标识',
...
CREATE TABLE `tour`  (
  ...
  `warehouse_street` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '仓库街道',
  `warehouse_house_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '仓库门牌号',
