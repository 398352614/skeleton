...
CREATE TABLE `batch` (
  ...
  `expect_distance` int(11) DEFAULT NULL COMMENT '预计里程',
  `actual_distance` int(11) DEFAULT NULL COMMENT '实际里程',
...
CREATE TABLE `material` (
  ...
  `out_order_no` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '外部订单号/标识',
...
CREATE TABLE `tour` (
  ...
  `car_no` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '车牌号',
  `warehouse_id` int(11) DEFAULT '0' COMMENT '仓库ID',
  `warehouse_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库名称',
  `warehouse_phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库电话',
  `warehouse_country` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库国家',
  `warehouse_post_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库邮编',
  `warehouse_city` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库城市',
  `warehouse_street` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库街道',
  `warehouse_house_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库门牌号',
  `warehouse_address` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库详细地址',
  `warehouse_lon` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库经度',
  `warehouse_lat` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库纬度',
  `warehouse_expect_time` int(11) DEFAULT '0' COMMENT '抵达仓库预计耗时',
  `warehouse_expect_distance` int(11) DEFAULT '0' COMMENT '抵达仓库预计历程',
  `warehouse_expect_arrive_time` datetime DEFAULT NULL COMMENT '抵达仓库预计时间',
...
CREATE TABLE `tracking_order` (
  ...
  `execution_date` date DEFAULT NULL COMMENT '取派日期',
  `warehouse_fullname` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-姓名',
  `warehouse_phone` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-手机号码',
  `warehouse_country` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-国家',
  `warehouse_post_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-邮编',
  `warehouse_house_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-门牌号',
  `warehouse_city` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-城市',
  `warehouse_street` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-街道',
  `warehouse_address` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-地址',
  `warehouse_lon` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-经度',
  `warehouse_lat` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '仓库-纬度',
...
CREATE TABLE `warehouse` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'ID',
  `company_id` int(11) NOT NULL COMMENT '公司ID',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '仓库名称',
