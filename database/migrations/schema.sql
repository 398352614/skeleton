...
CREATE TABLE `additional_package` (
  ...
  `tour_no` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '线路任务编号',
...
CREATE TABLE `batch` (
  ...
  `tour_no` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '线路任务编号',
  `line_id` int(11) DEFAULT NULL COMMENT '线路ID',
...
CREATE TABLE `driver_tour_trail` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'ID',
  `company_id` int(11) DEFAULT NULL COMMENT '公司ID',
  `tour_no` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '线路任务编号',
  `driver_id` int(11) DEFAULT NULL COMMENT '司机ID',
...
CREATE TABLE `line` (
  ...
  `is_increment` tinyint(4) DEFAULT '1' COMMENT '是否新增线路任务1-是2-否',
...
CREATE TABLE `recharge` (
  ...
  `tour_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '线路任务编号',
  `execution_date` date DEFAULT NULL COMMENT '取派日期',
