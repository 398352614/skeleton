...
Route::namespace('Api\Admin')->middleware(['companyValidate:admin', 'auth:admin', 'permission:admin'])->group(function () {
    ...
    Route::prefix('company-config')->group(function () {
        ...
        //调度规则
        Route::get('/rule', 'CompanyConfigController@rule_show')->name('company-config.rule-index');
        Route::put('/rule', 'CompanyConfigController@rule_update')->name('company-config.rule-update');
    });
    ...
    Route::prefix('bill')->group(function () {
        ...
        //充值详情
        Route::get('/merchant-recharge/{id}', 'BillController@show')->name('bill.merchant-index');
        //充值审核
