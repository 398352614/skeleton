...
class AssignBatch extends ATourNotify
{
    ...
    public function getDataList(): array
    {
        ...
        $packageList = Package::query()->whereIn('order_no', $orderNoList)->get(['order_no', 'express_first_no', 'express_second_no', 'out_order_no', 'expect_quantity', 'actual_quantity', 'status', 'sticker_no', 'sticker_amount'])->toArray();
