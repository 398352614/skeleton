...
abstract class ATourNotify2
{
    ...
    public function fillTrackingOrderList()
    {
        ...
        foreach ($trackingOrderList as $k => $v) {
            $trackingOrderList[$k]['tour_expect_arrive_time'] = $this->tour['expect_arrive_time'];
            ...
            $trackingOrderList[$k]['tour_actual_arrive_time'] = $this->tour['actual_arrive_time'];
