...
class OrderImportValidate extends BaseValidate
{
    ...
    public $rules = [
        ...
        'item_number_1'=>'required_unless:item_type_1,0|string|max:50|regex:/^[0-9A-Z-]([0-9A-Z-])*[0-9A-Z-]$/',
        ...
        'item_number_2'=>'required_unless:item_type_2,0|string|max:50|regex:/^[0-9A-Z-]([0-9A-Z-])*[0-9A-Z-]$/',
        ...
        'item_number_3'=>'required_unless:item_type_3,0|string|max:50|regex:/^[0-9A-Z-]([0-9A-Z-])*[0-9A-Z-]$/',
        ...
        'item_number_4'=>'required_unless:item_type_4,0|string|max:50|regex:/^[0-9A-Z-]([0-9A-Z-])*[0-9A-Z-]$/',
        ...
        'item_number_5'=>'required_unless:item_type_5,0|string|max:50|regex:/^[0-9A-Z-]([0-9A-Z-])*[0-9A-Z-]$/',
