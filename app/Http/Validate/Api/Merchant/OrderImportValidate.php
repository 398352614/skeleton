...
class OrderImportValidate extends BaseValidate
{
    ...
    public $rules = [
        ...
        'place_fullname' => 'required_if:type,1,3|string|max:50',
        'place_phone' => 'required_if:type,1,3|string|max:20|regex:/^[0-9]([0-9-])*[0-9]$/',
        'place_country' => 'nullable|string|max:20',
        'place_post_code' => 'required_if:type,1,3|string|max:50',
        'place_house_number' => 'required_if:type,1,3|string|max:50',
        "place_city" => 'required_if:type,1,3|string|max:50',
        "place_street" => 'required_if:type,1,3|string|max:50',
        'execution_date' => 'required_if:type,1,3|date|after_or_equal:today',

        'second_place_fullname' => 'required_if:type,2,3|string|max:50',
        'second_place_phone' => 'required_if:type,2,3|string|max:20|regex:/^[0-9]([0-9-])*[0-9]$/',
        'second_place_country' => 'nullable|string|max:20',
        'second_place_post_code' => 'required_if:type,2,3|string|max:50',
        'second_place_house_number' => 'required_if:type,2,3|string|max:50',
        "second_place_city" => 'required_if:type,2,3|string|max:50',
        "second_place_street" => 'required_if:type,2,3|string|max:50',
        'second_execution_date' => 'required_if:type,2,3|date|after_or_equal:today',
        ...
        "package_no_1" => 'nullable|sting|max:50',
        "package_name_1" => 'nullable|sting|max:50',
        ...
        "package_no_2" => 'nullable|sting|max:50',
        "package_name_2" => 'nullable|sting|max:50',
        ...
        "package_no_3" => 'nullable|sting|max:50',
        "package_name_3" => 'nullable|sting|max:50',
        ...
        "package_no_4" => 'nullable|sting|max:50',
        "package_name_4" => 'nullable|sting|max:50',
        ...
        "package_no_5" => 'nullable|sting|max:50',
        "package_name_5" => 'nullable|sting|max:50',
        ...
        "material_code_1" => 'nullable|sting|max:50',
        "material_name_1" => 'nullable|sting|max:50',
        ...
        "material_out_order_no_1" => 'required|sting|max:50',

        "material_code_2" => 'nullable|sting|max:50',
        "material_name_2" => 'nullable|sting|max:50',
        ...
        "material_out_order_no_2" => 'required|sting|max:50',

        "material_code_3" => 'nullable|sting|max:50',
        "material_name_3" => 'nullable|sting|max:50',
        ...
        "material_out_order_no_3" => 'required|sting|max:50',

        "material_code_4" => 'nullable|sting|max:50',
        "material_name_4" => 'nullable|sting|max:50',
        ...
        "material_out_order_no_4" => 'required|sting|max:50',

        "material_code_5" => 'nullable|sting|max:50',
        "material_name_5" => 'nullable|sting|max:50',
        ...
        "material_out_order_no_5" => 'required|sting|max:50',
