...
class DriverValidate extends BaseValidate
{
    ...
    public $rules = [
        ...
        'phone'                         => 'required|string|max:20|uniqueIgnore:driver,id',
        'duty_paragraph'                => 'required|string|max:50',
        'post_code'                     => 'required|string|max:50',
        'door_no'                       => 'required|string|max:50',
        'street'                        => 'required|string|max:100',
        'city'                          => 'required|string|max:100',
        'country'                       => 'required|string|max:100',
        'lisence_number'                => 'required|string|max:50',
        'lisence_valid_date'            => 'required|date|date_format:Y-m-d',
        'lisence_type'                  => 'required|string|max:100',
        'lisence_material'              => 'required|string|max:250',
        'lisence_material_name'         => 'nullable|string|max:250',
        'government_material'           => 'required|string|max:250',
