...
class CarValidate extends BaseValidate
{
    ...
    public $rules = [
        'car_no' => 'required|string|unique:car_info',
        ...
        'received_data' => 'required|date_format:Y-m-d',
        'month_road_tax' => 'required|numeric',
        'insurance_company' => 'required|string',
        'insurance_type' => 'required|integer',
        'month_insurance' => 'numeric',
        'rent_start_data' => 'nullable|required_if:ownership_type,0|date_format:Y-m-d',
        'rent_end_data' => 'nullable|required_if:ownership_type,0|date_format:Y-m-d',
        'rent_month_fee' => 'nullable|required_if:ownership_type,0|integer',
        'repair' => 'nullable|required_if:ownership_type,0|integer',
        'remark' => 'string',
        'relate_material' => 'required|array|max:10',
