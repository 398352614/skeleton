...
class HomeService extends BaseService
{
    ...
    public function home()
    {
        ...
        $totalOrder = parent::count(['execution_date' => ['between', [Carbon::today()->startOfDay()->format('Y-m-d H:i:s'), Carbon::today()->endOfDay()->format('Y-m-d H:i:s')]], 'status' => BaseConstService::ORDER_STATUS_3]);
