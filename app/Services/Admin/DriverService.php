...
class DriverService extends BaseService
{
    ...
    public function driverRegister()
    {
        $driver = [
            ...
            'lisence_material' => json_encode($this->formData['lisence_material'],JSON_UNESCAPED_SLASHES) ?? '',
            'lisence_material_name' => $this->formData['lisence_material_name'] ?? '',
            'government_material' => json_encode($this->formData['government_material'],JSON_UNESCAPED_SLASHES) ?? '',
