...
class TourService extends BaseService
{
    ...
    public function batchSign($id, $params)
    {
        ...
        if ($params['pay_type'] == BaseConstService::BATCH_PAY_TYPE_4 && (intval($batch['replace_amount']) !== 0 || intval($batch['settlement_amount']) !== 0 || intval($batch['sticker_amount']) !== 0 || intval($batch['delivery_amount']) !== 0)) {
