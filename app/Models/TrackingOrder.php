...
class TrackingOrder extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'type',
        'execution_date',
        'warehouse_place_fullname',
        'warehouse_place_phone',
        'warehouse_place_country',
        'warehouse_place_post_code',
        'warehouse_place_house_number',
        'warehouse_place_city',
        'warehouse_place_street',
        'warehouse_place_address',
        'warehouse_place_lon',
        'warehouse_place_lat',
        'place_fullname',
        'place_phone',
